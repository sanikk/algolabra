import unittest
from algolabra.fringe.ordered_set_version3 import LinkedMapForFringe

class TestBasicFunctionality(unittest.TestCase):
    def setUp(self):
        self.d = LinkedMapForFringe((5,5))
